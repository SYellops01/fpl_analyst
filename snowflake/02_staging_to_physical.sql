...
INSERT INTO FPL_KG.KG_NODE (NODE_ID, NODE_TYPE, NAME, PROPS)
SELECT
    'PERF_' || PLAYER_ID || '_' || GAMEWEEK_ID,
    'PERFORMANCE',
    'Player ' || PLAYER_ID || ' - GW' || GAMEWEEK_ID,
    STATS
...
INSERT INTO FPL_KG.KG_EDGE (EDGE_ID, SRC_ID, DST_ID, EDGE_TYPE, PROPS)
SELECT
    'RECORDED_FOR_PERF_' || PLAYER_ID || '_' || GAMEWEEK_ID || '_PLAYER_' || PLAYER_ID,
    'PERF_' || PLAYER_ID || '_' || GAMEWEEK_ID,
    'PLAYER_' || PLAYER_ID,
    'RECORDED_FOR',
    NULL
...
-- PERFORMANCE -> [IN_GAMEWEEK] -> GAMEWEEK
INSERT INTO FPL_KG.KG_EDGE (EDGE_ID, SRC_ID, DST_ID, EDGE_TYPE, PROPS)
SELECT
    'IN_GAMEWEEK_PERF_' || PLAYER_ID || '_' || GAMEWEEK_ID || '_GW_' || GAMEWEEK_ID,
    'PERF_' || PLAYER_ID || '_' || GAMEWEEK_ID,
    'GW_' || GAMEWEEK_ID,
    'IN_GAMEWEEK',
    NULL
...
INSERT INTO FPL_KG.KG_EDGE (EDGE_ID, SRC_ID, DST_ID, EDGE_TYPE, PROPS)
SELECT
    'IN_FIXTURE_PERF_' || PLAYER_ID || '_' || GAMEWEEK_ID || '_FIX_' || FIXTURE_ID,
    'PERF_' || PLAYER_ID || '_' || GAMEWEEK_ID,
    'FIX_' || FIXTURE_ID,
    'IN_FIXTURE',
    NULL
