...
CREATE OR REPLACE SCHEMA FPL_KG
    COMMENT = 'Schema for the universal node/edge model required in knowledge graph.';
...
GRANT CREATE NOTEBOOK ON SCHEMA FPL_ONTOLOGY_DB.FPL_KG TO ROLE DB_ENGINEER;
...
GRANT USAGE ON SCHEMA FPL_ONTOLOGY_DB.FPL_KG TO ROLE DB_ANALYST;
GRANT SELECT ON ALL TABLES IN SCHEMA FPL_ONTOLOGY_DB.FPL_KG TO ROLE DB_ANALYST;
GRANT SELECT ON FUTURE TABLES IN SCHEMA FPL_ONTOLOGY_DB.FPL_KG TO ROLE DB_ANALYST;
GRANT SELECT ON ALL VIEWS IN SCHEMA FPL_ONTOLOGY_DB.FPL_KG TO ROLE DB_ANALYST;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA FPL_ONTOLOGY_DB.FPL_KG TO ROLE DB_ANALYST;
GRANT READ ON ALL STAGES IN SCHEMA FPL_ONTOLOGY_DB.FPL_KG TO ROLE DB_ANALYST;
